        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4">
            <div className="bg-zinc-900 border border-zinc-700 rounded-3xl w-full max-w-md">
                <div className="flex items-center justify-between border-b border-zinc-700 px-6 py-5">
                    <h2 className="text-xl font-semibold">Добавить нового администратора</h2>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full bg-zinc-800 border border-zinc-700 rounded-2xl px-4 py-3 focus:border-yellow-400 outline-none"
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full bg-zinc-800 border border-zinc-700 rounded-2xl px-4 py-3 focus:border-yellow-400 outline-none pr-12"
                                placeholder="••••••••"
                                minLength={6}
                                required
                            />
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full bg-yellow-400 hover:bg-yellow-500 disabled:bg-yellow-600 text-black font-semibold py-4 rounded-2xl transition flex items-center justify-center gap-2"
                    >
